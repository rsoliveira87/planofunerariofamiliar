...
class whiterogue_breadcrumb_class {

    var $opts;

    function whiterogue_custom_breadcrumb() {
        ...
        echo '<section class="cont_nav"><div class="cont_nav_inner"><p><a href="' . esc_url(home_url('/')) . '/">' . 'Home' . '</a>';
        ...
        $output = $this->whiterogue_simple_breadcrumb_case($post);
    ...
    function whiterogue_simple_breadcrumb_case($der_post) {
        ...
        if (is_page()) {
            ...
            if ($der_post->post_parent) {
                ...
                $this->whiterogue_simple_breadcrumb_case($my_query);
        ...
        if (is_author()) {
            ...
            return 'Autor' . ' : ' . $curauth->display_name;
...
$instaapp_breadcumb = new whiterogue_breadcrumb_class();
